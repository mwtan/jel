 ...
 * @author Will Tan
 */
abstract class BinaryBitwiseShiftAssignExpression extends BinaryBitwiseShiftExpression {
	/**
	 ...
	 */
	BinaryBitwiseShiftAssignExpression(IExpression expr1, IExpression expr2) {
		super(expr1, expr2);
	}
