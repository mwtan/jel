 ...
 * <br>Will Tan - Removed logging and trace messages.
 * <br>Will Tan - Allow widening of parameters in isAssignmentCompatible.
 */
public class MethodUtils {
	...
	public static Object invokeMethod(Object object,
									  String methodName,
									  Object arg)
		throws NoSuchMethodException, IllegalAccessException, InvocationTargetException { // NOPMD - Grandfathered in method signature
		Object[] args = {
			arg};
	...
	public static Method getAccessibleMethod(Method method) {
		...
		Method meth = getAccessibleMethodFromInterfaceNest(clazz,
														   method.getName(),
	...
	static Method testGetAccessibleMethodFromInterfaceNest(Class clazz, 
			String methodName, Class parameterTypes[]) {
		return getAccessibleMethodFromInterfaceNest(clazz, methodName, parameterTypes);
	}
		...
		if (parameterType.isPrimitive()) {
			...
			if (parameterWrapperClazz != null) {
				return parameterWrapperClazz.equals(parameterization) ||
					canWiden(parameterType, parameterization);
			}
		}
	...
	private static boolean canWiden(Class methodParam, Class inParam) {
		if (methodParam == double.class && 
			    (inParam == short.class ||
				 inParam == int.class	|| 
				 inParam == long.class	|| 
				 inParam == float.class)) {
		...
		else if (methodParam == float.class &&
					(inParam == short.class || 
					 inParam == int.class   ||
					 inParam == long.class)) {
			return true;
		}
		else if (methodParam == long.class &&
					(inParam == short.class ||
					 inParam == int.class)) {
			return true;
		}
		else if (methodParam == int.class &&
				 inParam == short.class) {
			return true;
		}
		return false;
	}
	static boolean testCanWiden(Class methodParam, Class inParam) {
		return canWiden(methodParam, inParam);
	}
