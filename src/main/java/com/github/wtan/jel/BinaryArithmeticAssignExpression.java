...
/**
 * Base class for binary arithmetic assignment expressions.
 *
 * @author Will Tan
 */
abstract class BinaryArithmeticAssignExpression extends BinaryArithmeticExpression {
	/**
	 ...
	 */
	BinaryArithmeticAssignExpression(IExpression expr1, IExpression expr2) {
		super(expr1, expr2);
	}
